...
async def create_veiculo_manutencao(veiculo_manutencao: VeiculoManutencao):
...
async def get_all_veiculo_manutencoes():
...
async def get_veiculo_manutencao_by_id(veiculo_manutencao_id: str):
...
async def get_total_custo_manutencao_por_marca():
...
async def get_veiculos_com_mais_manutencoes(start_date: datetime, end_date: datetime):
...
async def get_manutencao_mais_cara_por_veiculo():
...
async def update_veiculo_manutencao(veiculo_manutencao_id: str, veiculo_manutencao_data: dict):
...
async def delete_veiculo_manutencao(veiculo_manutencao_id: str):
