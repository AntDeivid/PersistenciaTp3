...
@veiculo_manutencao_router.post("/", response_model=VeiculoManutencaoDTO, status_code=201)
async def create_veiculo_manutencao(veiculo_manutencao: VeiculoManutencaoDTO, veiculo_manutencao_repository: VeiculoManutencaoRepository = Depends(get_veiculo_manutencao_repository)):
...
@veiculo_manutencao_router.get("/", response_model=list[VeiculoManutencaoDTO])
...
@veiculo_manutencao_router.get("/{veiculo_manutencao_id}", response_model=VeiculoManutencaoDTO)
...
@veiculo_manutencao_router.put("/{veiculo_manutencao_id}", response_model=VeiculoManutencaoDTO)
